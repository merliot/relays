...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=docker&image=ghcr.io/merliot/relays&name=relays&instance_type=free&ports=8080;http;/&env[WS_SCHEME]=wss://)
